...
% - Implementation-specific tuning values should be supplied by the user.
%
...
season_id(ismember(month_by_day, []))   = 1;
season_id(ismember(month_by_day, []))   = 2;
season_id(ismember(month_by_day, [])) = 3;
season_id(ismember(month_by_day, []))  = 4;
